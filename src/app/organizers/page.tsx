      ...
      <div className="org-grid w-full max-w-5xl mx-auto px-6 pb-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {organizerCategories.map((category) => (
            <div
              key={category.id}
              className="org-card group relative rounded-sm overflow-hidden border border-cyan-400/30 bg-[#0f172a] shadow-[0_0_15px_rgba(0,255,255,0.08)] hover:shadow-[0_0_30px_rgba(0,255,255,0.2)] transition-shadow duration-500"
            >
              {/* Top Left Corner */}
